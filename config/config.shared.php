...
$conf['app']['weburi'] = 'http://www.gelmanlibrary.org/srrs_working_copy/trunk/';
...
$conf['app']['adminEmail'] = 'bietila@gelman.gwu.edu';
...
$conf['ui']['welcome'] = 'Welcome to Student Room Reservation System!';
...
// Can be 0 (for no) and 1 (for yes)
$conf['app']['prefixNameOnSummary'] = 0;
